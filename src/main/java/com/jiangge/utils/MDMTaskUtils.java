...
public class MDMTaskUtils {
    ...
    public static void createMobileconfig(String configPath, String tempPath, String deviceId) {
        try {
            Map<String, String> taskParam = new HashMap<>();
            for (Map.Entry<Object, Object> each : ConfigUtils.props.entrySet()) {
                taskParam.put(each.getKey().toString(), each.getValue().toString());
            }
