    ...
    <table width="100%" border="0">
        <tr>
            <td align="left" valign="top">
                <div class="right1">
                    <div class="top"><span>设备标签&nbsp;[<a
                            href="${sysadmin_ctx }/updateFlagInput.do?deviceId=${device.deviceId }" target="rightFrame"
                    ...
                    <form action="${sysadmin_ctx }/updateFlag.do" method="post" id="submitForm" name="submitForm">
                        ...
                        <table width="100%" border="0" cellspacing="10">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="deviceFlag" value="${device.deviceFlag }"/></td>
                            </tr>
                            <tr>
                                <td width="110" height="14" align="right"><input type="submit" value="数据提交"
