            ...
            <td align="left" valign="top">
                <div class="right1">
                    ...
                    <table width="100%" border="0" cellspacing="15"
                           style="height: 250px; border-bottom: 1px solid #F4F4F4;border-right: 1px solid #F4F4F4;border-left: 1px solid #F4F4F4;">
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td><img src="${images_ctx }/welcome.png" width="500px" style="margin-left: 50px"/></td>
                        </tr>
                    </table>
                </div>
                <!--主题部分的左边-->
