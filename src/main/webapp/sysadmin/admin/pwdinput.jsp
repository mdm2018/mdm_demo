    ...
    <table width="100%" border="0">
        <tr>
            <td align="left" valign="top">
                <div class="right1">
                    <div class="top"><span>密码修改&nbsp;[<a href="${sysadmin_ctx }/changePwdInput.do" target="rightFrame"
                    ...
                    <form action="${sysadmin_ctx }/changePwd.do" method="post" id="submitForm" name="submitForm">
                        ...
                        <table width="100%" border="0" cellspacing="10">
                            <tr>
                                <td width="110" height="14" align="right">用户名：</td>
                                <td>${sysadmin.email }</td>
                            </tr>
                            <tr>
                                <td width="110" height="14" align="right">密码：</td>
                                <td><input type="text" name="password" value=""
                                           style="width: 200px; height: 20px;"/><font color="red">[留空则不修改]</font></td>
                            </tr>
                            <tr>
                                <td width="110" height="14" align="right"><input type="button"
                                                                                 onclick="javascript:setPwdForm();"
                                                                                 value="提交请求"
