...
<frameset rows="70,*" cols="*" frameborder="no" border="0" framespacing="0">
    <frame src="${sysadmin_ctx }/top.do" name="topFrame" scrolling="no" noresize="noresize" id="topFrame"
           title="topFrame"/>
    <frameset cols="190,*" frameborder="no" border="0" framespacing="0">
        <frame src="${sysadmin_ctx }/left.do" name="leftFrame" scrolling="no" noresize="noresize" id="leftFrame"
               title="leftFrame"/>
