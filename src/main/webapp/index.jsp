...
<div class="am-g">
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        <form method="post" class="am-form" action="${ctx }/user/register.do">
            ...
            <br>
            <div class="am-cf">
                <button type="button" class="am-btn am-btn-primary btn-loading-example" onclick="userRegister();"
                        id="registerBtn">&nbsp;&nbsp;邮箱激活&nbsp;&nbsp;
                </button>
            </div>
        </form>
        <hr>
        <p>© 2016 移动互联百科. Licensed under Apache license.&nbsp;<a href="${ctx }/sysadmin/login.jsp"
                                                                 style="color:#333;font-size: 14px;text-decoration: underline;">账号登陆</a>
        </p>
    </div>
</div>
<div id="tb">
